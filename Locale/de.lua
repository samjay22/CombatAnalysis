...
L["DevelopedBy"] = "Entwickelt durch Evendale, weiterentwickelt durch Landal";
L["TranslatedBy"] = "Deutsche \195\156bersetzung von Dero/Amtholdiel/Ischabux";
...
L["largeFont"] = "Gr��ere Schrift ben�tigt neu laden";
...
L["StatsWindowsDescription"] = "> Ziehe die Statistik-Felder umher, um die Oberfl\195\164che zu rekonfigen\n> Ziehe unerw\195\188nschte Felder in die Ablage auf der rechten Seite";
...
L["NameRequiredPrefix"] = "Name ben\195\182tigt";

L["EffectName"] = "Effekt Name";
L["BuffName"] = "Buff Name";
L["DebuffName"] = "Debuff Name";
L["IconFileName"] = "Icon-Dateiname";
...
L["LargeFontTooltip"] = "Erh�hte SChrift im �berblick und Statistiken fenster. Wenn dies aktiviert ist musst du CA bewenden und neu laden. Ansonsten wird der Effekt beim n�chsten STart aktiviert";
...
L["TargetTimeoutTooltip"] = "Setze die Toleranzzeit nach dem Tod eines Gegners oder eines Spielers, in der Schaden weiterhin f\195\188r das Ziel gewertet wird. Beachte, dass diese Zeit geringer sein muss als der Kampf-Timeout.";
...
L["AutoSaveTooltip"] = "Konfiguriere, wie Daten automatisch gespeichert werden:\na) Daten werden nicht automatisch gespeichert\nb) Alle Daten (die gesamten K\195\164mpfe) werden beim Ausloggen gespeichert (oder beim Entladen des Plugins)\nc) Jeder Kampf wird gespeichert, sobald er beendet ist";
...
L["ShowMiniTitleBarTooltip"] = "F\195\188r dieses Fenster: Zeige oder verstecke den Titel der Minibar (mit den Men\195\188, Minimieren und Schlie\195\159en-Symbolen).";
...
L["ShowTargetsListTooltip"] = "F\195\188r dieses Fenster: Zeige oder verstecke die Ziel-Auswahlliste.";
...
L["CenterStatsWindowOnScreenTooltip"] = "Zentriere das Statistik-Fenster auf dem Bildschirm. Dadurch wird zudem sichergestellt, dass das Statistik-Fenster angezeigt wird (Immer anzeigen).";
L["VisibilityTooltip"] = "F\195\188r dieses Statistik-Fenster gib an:\na) Das Fenster soll immer angezeigt werden\nb) Das Fenster soll nur dann sichtbar sein, wenn sich eine Leiste unter dem Mauszeiger befindet oder in einem der Tabs verriegelt ist\nc) Das Fenster soll nur gezeigt werden, wenn die Details einer Leiste in einem der Tabs verriegelt ist";

L["SelectedConfigurationTooltip"] = "W\195\164hle, welche Eigenschafts-Konfiguration unten verwendet und editiert werden soll. Dies betrifft nur Debuff und Crowd Control Informationen.";
...
L["ConfigurationNameTooltip"] = "Definiere einen Namen f\195\188r die Eigenschafts-Konfiguration. Dieser kann sp\195\164ter nicht ge\195\164ndert werden.";
...
L["ConfigureInBuffBarsLinkTooltip"] = "Klicke um zum BuffBars Men\195\188 zu wechseln, wo du Effekt Fenster konfigurieren kannst, die Debuffs und/oder Crowd Control Effekte anzeigen, die in Abh\195\164ngigkeit von den unten gew\195\164hlten Einstellungen ausgel\195\182st werden. Beachte, dass diese zu den \"Mob Debuffs\" & \"Mob CC\" Kategorien in BuffBars z\195\164hlen.";
...
L["EffectModifiersTooltip"] = "Eine Liste von Effekten, die, wenn sie zum Zeitpunkt der Aktivierung des Debuffs auf dem Spieler aktiv sind, die Dauer des Debuffs verl\195\164ngern (oder verk\195\188rzen).";
...
L["StackingBuffsTooltip"] = "Eine Liste von Namen die f\195\188r den Buff angezeigt werden, wenn der Buff bereits aktiv war und erfolgreich \195\188berschrieben wurde.";
L["AddStackingBuffTooltip"] = "F\195\188ge einen neuen stapelbaren Effektnamen hinzu.";
L["RemoveStackingBuffTooltip"] = "Entferne den gew\195\164hlten Namen aus der Liste der stapelbaren Effektnamen.";
L["LogNameTooltip"] = "Spezifiziere den Namen des Kampflog Eintrags, der zu dem Temp-Moral Skill passt, der genutzt wird, um einen Bubble Effekt dem ausl\195\182senden Spieler zuzuordnen. Der Name muss exakt mit dem Namen des Skills \195\188bereinstimmen, wie er im Kampflog erscheint.";
...
L["DelayTooltip"] = "Setze die Verz\195\182gerung nach Stattfinden der Anwendung, bis der Skill aktiviert wird. Beachte, dass dies ein kleiner negativer Wert sein kann, um eine Verz\195\182gerung auszugleichen bevor der Kampflogeintrag erscheint.";
L["DurationTooltip"] = "Setze die Dauer, \195\188ber die der Debuff anh\195\164lt.";

-- Tutorials

L["DoNotShowHintInFuture"] = " Diese Hinweise in\n  Zukunft nicht anzeigen"; -- be sure to include line break and spaces
L["LogoTitle"] = "Das Combat Analysis Logo";
L["LogoMessage"] = "Linksklick auf das neue Logo um alle Combat Analysis Fenster zu \195\182ffnen oder zu schlie\195\159en. Rechtsklick, um ein Mini-Men\195\188 zu erhalten, von dem du Zugriff hast auf den Laden/Speichern Dialog oder das Hauptmen\195\188.\n\nBewege das Logo durch Dr\195\188cken von 'Control-#'. Alternativ kannst du es auch ausschalten im Men\195\188.";
...
L["ToggleCommand"] = "umschalten";
L["SaveCommand"] = "speichern";
L["LoadCommand"] = "laden";
L["LockCommand"] = "sperren";
L["UnlockCommand"] = "entsperren";
L["ResetCommand"] = "zur\195\188cksetzen";
L["ResetTotalsCommand"] = "zur\195\188cksetzen gesamtwerte";
L["LockToggleCommand"] = "sperren umschalten";

L["CommandUsage"] = "Verwendung: /ca "..L.Options.." | "..L.SaveCommand.." | "..L.LoadCommand.." | "..L.ToggleCommand.." | "..L.ShowCommand.." | "..L.HideCommand.." | "..L.LockToggleCommand.." | "..L.LockCommand.." | "..L.UnlockCommand.." | "..L.ResetCommand.." | "..L.ResetTotalsCommand;
...
L["ResetTotalsMessage"] = "Bist du dir sicher, dass du die Gesamtwerte zur\195\188cksetzen willst?";
L["Yes"] = "Ja";
L["No"] = "Nein";
L["OK"] = "OK";
...
L["Beorning"] = {"Beorninger","BRN"};
L["Brawler"] = {"Shlarger", "BRW"};
...
L["OverwriteFileMessage"] = "Datei existiert bereits. M\195\182chtest du die gespeicherten Daten mit dieser Datei kombinieren oder sie \195\188berschreiben?";
L["CombineOrSeparateMessage"] = "Du hast mehrere Dateien gew\195\164hlt. Willst du die Daten kombinieren oder einzeln laden?";
L["TooManyCharactersMessage"] = "Der gew\195\164hlte Dateiname ist zu lang.\n(Maximale L\195\164nge = 64 Zeichen)";
...
L["LoadBeforeSaveMessage"] = "Eine der gew\195\164hlten Dateien wird derzeit gespeichert und kann daher noch nicht geladen werden. Versuche es in 10-15 Sekunden erneut";

L["Combine"] = "Kombinieren";
L["Combines"] = "Kombinieren";
L["Overwrite"] = "\195\156berschreiben";
...
L["Say"] = {"sagen","Sagen"};
L["Fellowship"] = {"g","Gef\195\164hrtengruppe"};
...
L["Criticals"] = "Krits";
L["Devastates"] = "Zerst\195\182rerische";
...
L["Recommendations"] = "Empfehlungen";
L["RecNoData"] = "Noch keine Daten";

L["CombatSummaryTopSkills"] = "Top-F\195\164higkeiten";
L["CombatSummaryDPS"] = "DPS";
L["CombatSummaryHPS"] = "HPS";
L["CombatSummaryNewBest"] = "Neuer pers\195\182nlicher Rekord!";
L["CombatSummaryPrev"] = "war";
L["CombatSummaryBestDPS"] = "Bester DPS";
L["ShowCombatSummary"] = "Kampfzusammenfassung anzeigen";
L["ShowCombatSummaryTooltip"] = "Zeigt nach jedem Kampf eine kurze Zusammenfassung mit DPS, Top-F\195\164higkeiten und pers\195\182nlichem Rekord an.";

L["Session"] = "Sitzung";
L["SessionCombatTime"] = "Kampfzeit";
L["SessionAvgPS"] = "Durchschnitt /s";
L["SessionBestPS"] = "Bester /s";
L["SessionNoData"] = "Noch keine K\195\164mpfe";
...
L["DevastateHits"] = "Verw�sten Treffer";    
...
L["Misses"] = "Verfehlt";
L["Deflects"] = "Abgelenkt";
L["Immune"] = "Immun";
L["Resists"] = "Widerstanden";
...
L["Dmg"] = {"Schaden","Schaden","DPS","Schaden Tab","Ausgehender Schaden Tab"}
L["Taken"] = {"Erlitten","Erlittener Schaden","EPS","Erlittener Tab","Eingehender (erlittener) Schaden Tab"}
...
L["AvoidanceEnum"] = {{"Kein","Kein"},{"Verfehlt","Verfehlt"},{"Immun","Immun"},{"Widerstanden","Widerstanden"},
...
L["DmgTypeEnum"] = {{"Allgemein","Allgemein"},{"Feuer","Feuer"},{"Blitz","Blitz"},{"Frost","Frost"},{"S\195\164ure","S\195\164ure"},{"Schatten","Schatten"},{"Licht","Licht"},
                    {"Bele","Beleriand"},{"West","Westernis"},{"UZ","Uralte Zwergenart"},{"OrkW","Ork-Waffe"},{"Hass","Hass"},{"Kein","Kein"}}
...
L["AdvancedStartlingTwist"] = "Bessere \195\156berraschende Wende";
...
L["Fleetness"] = "Schnellf\195\188\195\159igkeit";
L["ImprovedFleetness"] = "Verbesserte Schnellf\195\188\195\159igkeit";
...
-- 11) Beorning
-- Traits
L["WayofTheHide"] = "Der Pelz"
L["WayofTheClaw"] = "Die Klaue"
L["WayofTheRoar"] = "Mit Gebr\195\188ll"

-- 12 Brawler
L["TheFulcrum"] = "Der Drepunkt";
L["TheMaelstrom"] = "Der Maelstrom";
L["TheFundament"] = "Der Fundament";
...
-- Buffs
L["EncouragingRoar"] = "Ermutigendes Gebr\195\188ll";
L["RejuvenatingBellow"] = "Erfrischendes Knurren";
L["BracingRoar"] = "St\195\164rkendes Gebr\195\188ll";
L["Sacrifice"] ="Aufopferung";
L["BearUp"] ="Bear Up";
L["VigilantRoar"] = "Aufmerksames Gebr\195\188ll";
L["AssertiveRoar"] = "Eindringliches Gebr\195\188ll";
L["SluggishStings"] = "Schwerf\195\164llige Stiche";
L["EnragingSacrifice"] = "Erz\195\188rnende Aufopferung";
L["DebilitatingBees"] = "Schw\195\164chende Bienen";
L["EncouragingStrike"] = "Ermutigender Angriff";
L["ShakeFree"] = "Absch\195\188tteln";
L["Takedown"] = "Zu Fall gebracht";
L["CripplingStings"] = "L\195\164hmende Stiche";
L["CripplingRoar"] = "L\195\164hmendes Gebr\195\188ll";
L["ThickenedHide"] ="Verdichteter Pelz";
L["Counter"] = "Konter";
L["CallToWild"] = "Ruf der Wildnis";

-- Crowd control
L["GrislyCry"] = "Grausiger Schrei";
